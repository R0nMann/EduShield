...
const handleSubmit = async (e) => {
    ...
    <div className="hidden md:flex md:w-3/7 bg-gray-200 flex-col gap-6 items-center justify-center">
    ...
    <div className="w-full md:w-4/7 flex items-center justify-center min-h-screen md:min-h-0">
        <div className="w-full max-w-md p-6 sm:p-8">
            ...
            <div className="flex flex-col items-center gap-2 mb-3">
                ...
                <School2 />
                <h1 className="text-2xl sm:text-3xl font-bold mb-2">School Sign-Up</h1>
                </div>
            </div>
                ...
                {role === "school" ? (
                    ...
                    <>
                        ...
                        <input type="email" name="email" placeholder="Email"
                            value={formData.email || ""} onChange={handleChange} required
                            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black" />
                        <input type="text" name="class" placeholder="Class/Grade"
                            value={formData.class || ""} onChange={handleChange}
                            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black" />
                        <input type="text" name="section" placeholder="Section"
                            value={formData.section || ""} onChange={handleChange}
                            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black" />
                        <input type="text" name="rollNumber" placeholder="Roll Number (Optional)"
