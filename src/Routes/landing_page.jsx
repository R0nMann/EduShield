      ...
      <div className="px-6 py-12">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16">
          ...
          <div className="text-center">
            ...
            <Link to="/schoollogin"><button className="bg-black text-white px-8 py-3 rounded font-semibold hover:bg-gray-800 transition-colors mb-8">
              Log in
            </button></Link>
            <div className="text-center">
              <p className="text-gray-600 mb-2">Don't have an account?</p>
              <Link to="/schoolsignin"><button className="text-black font-semibold underline hover:no-underline">
                Sign up
              </button></Link>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <Link to="/studentlogin"><button className="bg-black text-white px-8 py-3 rounded font-semibold hover:bg-gray-800 transition-colors mb-8">
              Log in
            </button></Link>
            <div className="text-center">
              <p className="text-gray-600 mb-2">Don't have an account?</p>
              <Link to="/studentsignin"><button className="text-black font-semibold underline hover:no-underline">
                Sign up
              </button></Link>
            </div>
          </div>
